...
Files.md keeps your notes as plain Markdown, but the viewer can render more than text:

- Attach images by pasting, dragging them onto the editor, or using the image button in the toolbar. Images are saved under `media/` and inserted as regular Markdown links.
- Reference existing images with Markdown syntax, for example `![diagram](media/diagram.png)`.
