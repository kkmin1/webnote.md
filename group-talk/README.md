...
- 실시간 그룹 채팅
- 다중 사용자 참여
- NVIDIA Free Endpoint, Ollama Cloud, OpenCode Zen free model, Codex가 함께 참여하는 멀티봇 토론
...
- Node.js + Express
- Socket.io
- NVIDIA NIM / Ollama / OpenCode Zen / Codex CLI
...
참고:
- 문서: [OpenCode Zen docs](https://opencode.ai/docs/zen/)
- 현재 free 모델은 시점에 따라 바뀔 수 있습니다
...
4. 메시지를 보내면 NVIDIA, Ollama, OpenCode Zen, Codex 멤버가 병렬로 응답
...
- 제공자 선택 UI (NVIDIA / Ollama / OpenCode Zen / Codex 등)
- 메시지 기록 저장 (데이터베이스)
- 파일 공유 기능
- 이모지 지원
- 읽음 확인 기능
